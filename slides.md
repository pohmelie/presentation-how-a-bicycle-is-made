...
* Используйте сахар и новые фичи питона

# Presenter Notes
очищает бизнес-логику
...
* Используйте сахар и новые фичи питона
* Большая часть сахара может быть реализована с помощью magic methods
...
* Используйте сахар и новые фичи питона
* Большая часть сахара может быть реализована с помощью magic methods
* Асинхронные фреймворки это просто!

![async-is-easy](images/async-is-easy.png)

# Presenter Notes
все асинхронные фреймворки основаны на одной идее: один системный вызов для множества "ожидающих"
